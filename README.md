...
```shell
# docker login ...
heighliner build -r kcr.infra.p2p.org/cosmos/cosmos-heighliner -c gaia -g v6.0.0
```

Docker image `kcr.infra.p2p.org/cosmos/cosmos-heighliner/gaia:v6.0.0` will be built and pushed to kcr.infra.p2p.org

#### Example: build and push last n releases of osmosis chain

```shell
# docker login ...
heighliner build -r kcr.infra.p2p.org/cosmos/cosmos-heighliner -c osmosis -n 3
```

heighliner will fetch the last 3 osmosis release tags from github, build docker images, and push them, e.g.:
- `kcr.infra.p2p.org/cosmos/cosmos-heighliner/osmosis:v6.1.0`
- `kcr.infra.p2p.org/cosmos/cosmos-heighliner/osmosis:v6.0.0`
- `kcr.infra.p2p.org/cosmos/cosmos-heighliner/osmosis:v5.0.0`
...
heighliner build -r kcr.infra.p2p.org/cosmos/cosmos-heighliner -n 3
```
...
```shell
heighliner build -b --buildkit-addr tcp://192.168.1.5:8125 -c gaia -g v7.0.1 -r kcr.infra.p2p.org/cosmos/cosmos-heighliner
```
